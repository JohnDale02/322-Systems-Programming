 ...
 */
struct player {
  struct hand* card_list;    // Creating initialized hand object called card_list 
  char book[7];		    // 7 character array for books
  size_t numBook;		  
  size_t hand_size;	   // how many cards are currently in hand
 int reset;   // was the player just reset?
};
